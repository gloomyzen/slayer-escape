...
if __name__ == "__main__":
    buildNumFile = 'buildnum.ver'
    infoPlistFile = '../proj.ios_mac/ios/Info.plist'
    ...
    (version, build) = upver(buildNumFile)
    if version == None or build == None:
        sys.exit(2)
    ...
    set_plist_version(infoPlistFile, version, build)
